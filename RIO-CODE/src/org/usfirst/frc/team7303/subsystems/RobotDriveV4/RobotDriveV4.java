...
import org.usfirst.frc.team7303.robot.Constants;
import org.usfirst.frc.team7303.robot.Robot;
import org.usfirst.frc.team7303.robot.RobotMap;
import org.usfirst.frc.team7303.shared.AutoTrajectory.*;
import org.usfirst.frc.team7303.shared.MixedDrive;
...
public class RobotDriveV4 extends Subsystem implements PIDOutput, PIDSource {
    ...
    public RobotDriveV4() {
        m_MixedDriveInstance = new MixedDrive(RobotMap.driveFrontLeft, RobotMap.driveFrontRight);
            ...
            if(DriverStation.getInstance().isEnabled()){
                switch (driveControlState){
                    ...
                    default: //open loop
                        ...
                        driveCartesian(operatorInput[1], operatorInput[2]);
                        break;
                }
            }
     ...
     */
    private void driveCartesian(double ySpeed, double zRotation) {
        m_MixedDriveInstance.arcadeDrive(ySpeed, zRotation);
    }

...
plot robotfile using 1:($9*1000) axes x1y1 with line title "In Auto" lw 3 lc rgb "red", \
	 ...
	 robotfile using 1:($12*1000) axes x1y1 with points title "Left Talon Voltage" lw 3 lc rgb "blue", \
	 robotfile using 1:($13*1000) axes x1y1 with points title "Right Talon Voltage" lw 3 lc rgb "red"
